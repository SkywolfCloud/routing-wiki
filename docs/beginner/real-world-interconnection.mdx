...
:::note
有一个特例，MPLS可以运行在GRE上，详情在 RFC4023 。
:::
...
:::note
  ...
  另外，Endpoint 可以两边都写，也可以只写一边（例如只有一边有公网
  IP），但不能两边都不写！
:::
